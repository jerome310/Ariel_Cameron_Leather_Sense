...
var confetti = {
  ...
  alpha: 1.0, //the alpha opacity of the confetti
...
// ---------------- Celebrate Button (already in your code) ----------------
window.onload = function () {
  ...
  let checkoutButton = document.querySelector(".bg-blue-600.text-white");
  if (checkoutButton) {
